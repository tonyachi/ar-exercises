...
@store1.employees.create(first_name: "Alky", last_name: "Ohra", hourly_rate: 30)
@store1.employees.create(first_name: "Hanna", last_name: "Gready", hourly_rate: 30)
@store1.employees.create(first_name: "Kris", last_name: "Bold", hourly_rate: 30)
